...
h1:before {
  ...
  border-bottom: 10px solid #8f0414;
  content: ' ';
  height: 0;
  position: absolute;
  right: -74px;
...
.stark-login form {
  ...
  background: #111;
  background: linear-gradient(darkred, #111111);
  border: 6px solid #darkred;
  box-shadow: 0 0 15px #e04f62;
  border-radius: 5px;
...
.stark-login form:hover {
  border: 6px solid #e04f62;
  box-shadow: 0 0 25px #e04f62;
  transition: 1s all;
}
.stark-login input {
  background: #222;
...
@keyframes text-glow {
  ...
  100% {
    color:  #d61e40;
    text-shadow: 0 0 20px rgba(245, 66, 69, 0.6), 0 0 10px rgba(245, 66, 69, 0.4), 0 2px 0 #000;
  }
}
@keyframes before-glow {1
  0% {
    border-bottom: 10px solid #690815;
  }
  100% {
    border-bottom: 10px solid #cf2d43;
  }
}
@keyframes after-glow {
  0% {
    border-top: 16px solid #690815;
  }
  100% {
    border-top: 16px solid #cf2d43;
  }
}
@keyframes circle1 {
  0% {
